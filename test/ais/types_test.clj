...
(deftest e-test
  (testing "Parse value / lookup value - 1"
    (is (= (e e-test-vocab nil "00001") "foo")))
  (testing "Parse value / lookup value - 2"
    (is (= (e e-test-vocab nil "00010") "bar")))
  (testing "Parse value / lookup value - 3"
    (is (= (e e-test-vocab nil "00011") "baz"))))
...
(defn dynamic_array-mapper [bits]
  (let [map-id (u nil (subs bits 0 2))]
    (condp = map-id
      1 foo
      2 bar
      3 baz
