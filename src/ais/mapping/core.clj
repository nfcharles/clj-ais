(ns ais.mapping.core
  (:require [clojure.string :as string]
            ...
            [ais.mapping.type_16 :as type_16]
            ...
            [ais.mapping.type_25 :as type_25]
            [ais.mapping.type_26 :as type_26]
...
(defn field-parsers [msg-type bits]
  (case (int msg-type)
   ...
   16 (type_16/determine-16-map bits)
   ...
   25 (type_25/determine-25-map bits)
   26 (type_26/determine-26-map bits)
